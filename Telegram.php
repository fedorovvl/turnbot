...
class Telegram
{
     ...
     * \return the JSON Telegram's reply.
     */
    public function forwardMessage($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function sendAudio($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function sendDocument($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function sendSticker($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function sendLocation($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function sendVenue($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function sendChatAction($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function getUserProfilePhotos($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function kickChatMember($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function unbanChatMember($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function getChatAdministrators($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function getChatMembersCount($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function getChatMember($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function answerInlineQuery($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function setGameScore($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function answerCallbackQuery($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function editMessageText($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function editMessageCaption($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function editMessageReplyMarkup($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function sendInvoice($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function answerShippingQuery($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function answerPreCheckoutQuery($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function sendVideoNote($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function restrictChatMember($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function promoteChatMember($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function exportChatInviteLink($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function setChatPhoto($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function deleteChatPhoto($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function setChatTitle($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function setChatDescription($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function pinChatMessage($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function unpinChatMessage($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function getStickerSet($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function uploadStickerFile($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function createNewStickerSet($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function addStickerToSet($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function setStickerPositionInSet($content)
    {
     ...
     * \return the JSON Telegram's reply.
     */
    public function deleteStickerFromSet($content)
    {
    ...
    private function sendAPIRequest($url, $content, $post = true)
    {
        ...
        if (class_exists('TelegramErrorLogger')) {
            $loggerArray = ($this->getData() == null) ? array($content) : array($this->getData(), $content);
